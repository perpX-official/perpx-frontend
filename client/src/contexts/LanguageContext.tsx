...
const translations = {
  en: {
    ...
    "rewards.totalPoints": "Total Points Today",
    "rewards.loginBonus": "Login Bonus",
    "rewards.loginBonusDesc": "Login daily to earn rewards",
    "rewards.demoTrade": "Complete 3 Demo Trades",
    "rewards.demoTradeDesc": "Experience trading in learning mode",
    "rewards.socialPost": "Post on X (Twitter)",
    "rewards.socialPostDesc": "Tweet about PerpX",
    "rewards.weeklyLogin": "7-Day Login Streak",
    "rewards.weeklyLoginDesc": "Login daily for a week to earn special rewards",
    ...
    "rewards.joinGuildDesc": "Join a guild to earn special rewards (one-time)",
    "rewards.login": "Login",
    "rewards.trade": "Trade",
    "rewards.post": "Post",
  ...
  jp: {
    ...
    "rewards.socialPost": "X (Twitter) に投稿",
    "rewards.socialPostDesc": "PerpXについてツイート",
    ...
    "rewards.joinGuildDesc": "ギルドに参加して特別報酬を獲得（一回限り）",
    "rewards.login": "ログイン",
    "rewards.trade": "取引する",
    "rewards.post": "投稿する",
  ...
  cn: {
    ...
    "rewards.totalPoints": "今日总积分",
    "rewards.loginBonus": "登录奖励",
    "rewards.loginBonusDesc": "每日登录赚取奖励",
    "rewards.demoTrade": "完成3次模拟交易",
    "rewards.demoTradeDesc": "在学习模式中体验交易",
    "rewards.socialPost": "在X (Twitter)上发布",
    "rewards.socialPostDesc": "发推介绍PerpX",
    "rewards.weeklyLogin": "7天连续登录",
    "rewards.weeklyLoginDesc": "连续一周每日登录赚取特别奖励",
    ...
    "rewards.joinGuildDesc": "加入公会赚取特别奖励（仅限一次）",
    "rewards.login": "登录",
    "rewards.trade": "交易",
    "rewards.post": "发布",
    "rewards.claim": "领取奖励",
