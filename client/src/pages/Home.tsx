          ...
          <div className="flex items-center justify-between">
            <Link href="/">
              <div className="flex items-center gap-2 sm:gap-3 cursor-pointer">
                ...
                <span className="text-xl sm:text-2xl font-bold text-gradient">PerpX</span>
              </div>
            </Link>
            <Link href="/trade">
              <button className="button-scale-fade neumorphic px-4 sm:px-8 py-2 sm:py-3 rounded-xl font-semibold text-sm sm:text-lg">
